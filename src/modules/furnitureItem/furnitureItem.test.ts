...
const modelDelegate = prismaMock.furnitureItem;
...
describe('FurnitureItem API', () => {
  const basePath = '/api/v1/furnitureItems';
  const existingKey = {
    id: 'existing-id',
  };
  const missingKey = {
  ...
  describe('POST ' + basePath, () => {
    it('creates a new furnitureItem with mocked Prisma', async () => {
