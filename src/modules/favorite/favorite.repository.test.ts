...
const { FavoriteRepository } = await import('./favorite.repository.js');

const delegate = prismaMock.favorite;

describe('FavoriteRepository', () => {
  let repo: InstanceType<typeof FavoriteRepository>;
  ...
  describe('create', () => {
    it('creates and returns a new record', async () => {
      const data = { type: 'GALLERY_ITEM', galleryItemId: 'test-galleryItemId', unitId: 'test-unitId' };
