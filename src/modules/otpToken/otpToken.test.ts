...
const modelDelegate = prismaMock.otpToken;
...
describe('OtpToken API', () => {
  const basePath = '/api/v1/otpTokens';
  const existingKey = {
    id: 'existing-id',
  };
  const missingKey = {
  ...
  describe('POST ' + basePath, () => {
    it('creates a new otpToken with mocked Prisma', async () => {
