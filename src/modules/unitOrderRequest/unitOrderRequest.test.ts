...
const modelDelegate = prismaMock.unitOrderRequest;
...
describe('UnitOrderRequest API', () => {
  const basePath = '/api/v1/unitOrderRequests';
  const existingKey = {
    id: 'existing-id',
  };
  const missingKey = {
  ...
  describe('POST ' + basePath, () => {
    it('creates a new unitOrderRequest with mocked Prisma', async () => {
