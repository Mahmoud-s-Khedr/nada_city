...
export class UnitOrderRequestController {
  ...
  /**
   * GET /api/unitOrderRequests/cursor
  ...
  /**
   * PATCH /api/unitOrderRequests/:id
   */
  ...
  /**
   * DELETE /api/unitOrderRequests/:id
   */
