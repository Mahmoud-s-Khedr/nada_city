...
const modelDelegate = prismaMock.specialFurnitureRequest;
...
describe('SpecialFurnitureRequest API', () => {
  const basePath = '/api/v1/specialFurnitureRequests';
  const existingKey = {
    id: 'existing-id',
  };
  const missingKey = {
  ...
  describe('POST ' + basePath, () => {
    it('creates a new specialFurnitureRequest with mocked Prisma', async () => {
