...
const modelDelegate = prismaMock.passwordResetToken;
...
describe('PasswordResetToken API', () => {
  const basePath = '/api/v1/passwordResetTokens';
  const existingKey = {
    id: 'existing-id',
  };
  const missingKey = {
  ...
  describe('POST ' + basePath, () => {
    it('creates a new passwordResetToken with mocked Prisma', async () => {
