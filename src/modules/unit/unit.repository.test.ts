...
const delegate = prismaMock.unit;

describe('UnitRepository', () => {
  let repo: InstanceType<typeof UnitRepository>;
  ...
  describe('create', () => {
    it('creates and returns a new record', async () => {
      const data = { title: 'test-title', description: 'test-description', keywords: 'test-keywords' };
