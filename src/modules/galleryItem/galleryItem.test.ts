...
const modelDelegate = prismaMock.galleryItem;
...
describe('GalleryItem API', () => {
  const basePath = '/api/v1/galleryItems';
  const existingKey = {
    id: 'existing-id',
  };
  const missingKey = {
  ...
  describe('POST ' + basePath, () => {
    it('creates a new galleryItem with mocked Prisma', async () => {
